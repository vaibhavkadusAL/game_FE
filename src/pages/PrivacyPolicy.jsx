  ...
  return (
    <div className="legal-page section-padding" style={{ background: 'rgba(18, 14, 36, 0.4)' }}>
      ...
      <div className="container" style={{ maxWidth: '800px', margin: '0 auto', color: 'var(--text-muted)', lineHeight: '1.8' }}>
        <h1 className="text-gradient-purple" style={{ fontSize: '2.5rem', marginBottom: '24px', textAlign: 'center' }}>Privacy Policy</h1>
        ...
        <h2 style={{ color: '#fff', fontSize: '1.5rem', marginTop: '30px', marginBottom: '12px' }}>1. Consent</h2>
        <p style={{ marginBottom: '20px' }}>
          By using our website, you hereby consent to our Privacy Policy and agree to its terms.
        </p>

        <h2 style={{ color: '#fff', fontSize: '1.5rem', marginTop: '30px', marginBottom: '12px' }}>2. Information We Collect</h2>
        <p style={{ marginBottom: '20px' }}>
          If you contact us directly, we may receive additional information about you such as your name, email address, phone number, the contents of the message and/or attachments you may send us, and any other information you may choose to provide.
        </p>

        <h2 style={{ color: '#fff', fontSize: '1.5rem', marginTop: '30px', marginBottom: '12px' }}>3. How We Use Your Information</h2>
        <p style={{ marginBottom: '20px' }}>
        ...
        <h2 style={{ color: '#fff', fontSize: '1.5rem', marginTop: '30px', marginBottom: '12px' }}>4. Log Files & Cookies</h2>
        <p style={{ marginBottom: '20px' }}>
          YONO Games follows a standard procedure of using log files. These files log visitors when they visit websites. The information collected by log files includes internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable.
        </p>

        <h2 style={{ color: '#fff', fontSize: '1.5rem', marginTop: '30px', marginBottom: '12px' }}>5. Third Party Privacy Policies</h2>
        <p style={{ marginBottom: '20px' }}>
        ...
        <h2 style={{ color: '#fff', fontSize: '1.5rem', marginTop: '30px', marginBottom: '12px' }}>6. Children's Information</h2>
        <p style={{ marginBottom: '20px' }}>
