  ...
  return (
    <div className="legal-page section-padding" style={{ background: 'rgba(18, 14, 36, 0.4)' }}>
      ...
      <div className="container" style={{ maxWidth: '800px', margin: '0 auto', color: 'var(--text-muted)', lineHeight: '1.8' }}>
        <h1 className="text-gradient-purple" style={{ fontSize: '2.5rem', marginBottom: '24px', textAlign: 'center' }}>Disclaimer</h1>
        ...
        <h2 style={{ color: '#fff', fontSize: '1.5rem', marginTop: '30px', marginBottom: '12px' }}>1. General Information Disclosure</h2>
        <p style={{ marginBottom: '20px' }}>
        ...
        <h2 style={{ color: '#fff', fontSize: '1.5rem', marginTop: '30px', marginBottom: '12px' }}>2. External Hyperlinks</h2>
        <p style={{ marginBottom: '20px' }}>
          From our website, you can visit other websites by following hyperlinks to such external sites. While we strive to provide only quality links to useful and ethical websites, we have no control over the content and nature of these sites. These links to other websites do not imply a recommendation for all the content found on these sites. Site owners and content may change without notice and may occur before we have the opportunity to remove a link which may have gone 'bad'.
        </p>

        <h2 style={{ color: '#fff', fontSize: '1.5rem', marginTop: '30px', marginBottom: '12px' }}>3. Independent Status</h2>
        <p style={{ marginBottom: '20px' }}>
        ...
        <h2 style={{ color: '#fff', fontSize: '1.5rem', marginTop: '30px', marginBottom: '12px' }}>4. Responsible Gaming (18+)</h2>
        <p style={{ marginBottom: '20px' }}>
